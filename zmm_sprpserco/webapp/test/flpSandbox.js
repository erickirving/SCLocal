		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#zmmsprpsercozmmsprpserco-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zmmsprpsercozmmsprpserco-display": {
								"semanticObject": "zmmsprpsercozmmsprpserco",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zmmsprpserco.zmmsprpserco",
									"url": sap.ui.require.toUrl("zmmsprpserco/zmmsprpserco")
								}
							}
						}
					}
